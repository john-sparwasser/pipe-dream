...
public partial class LevelPropertiesWindow : Window
{
    ...
    private void Build()
    {
        ...
        // Layer 3's two fields — the priority flag here and the option in the entrance record —
        // moved to the Background tab's "Layer 3 Options", where the result is on screen.
